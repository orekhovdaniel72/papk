...
- [x] Схема БД: share_links (slug, resume_id, password_hash, expires_at, view_limit, revoked)
- [x] Кабинет: генерация ссылок (опц. пароль + срок + лимит просмотров), отзыв
- [x] Публичная страница /r/[slug] — открытие резюме по токену
